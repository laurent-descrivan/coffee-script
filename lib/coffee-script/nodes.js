...
(function() {
  ...
  ayl_stackify_patch = (typeof process !== "undefined" && process !== null ? process.env["AYL_COFFEESCRIPT_STACKIFY"] : void 0) === "true";
...
/* TFLAGG2 */(o, lvl) {
    ...
    Base["prototype"].compileToFragments = function
/* TFLAGG2 */(o, lvl) {
      var node;
    ...
    Base["prototype"].compileClosure = function
/* TFLAGG2 */(o) {
      var jumpNode;
...
/* TFLAGG2 */(o, level, reused) {
    ...
    Base["prototype"].cacheToCodeFragments = function
/* TFLAGG2 */(cacheValues) {
...
/* TFLAGG2 */(res) {
    ...
    Base["prototype"].contains = function
/* TFLAGG2 */(pred) {
      var node;
...
/* TFLAGG2 */(n) {
    ...
    Base["prototype"].lastNonComment = function
/* TFLAGG2 */(list) {
      var i;
...
/* TFLAGG2 */(node) {
    ...
    Base["prototype"].eachChild = function
/* TFLAGG2 */(func) {
...
/* TFLAGG2 */(crossScope, func) {
      return this.eachChild(function
/* TFLAGG2 */(child) {
        if (func(child) === false) {
          return false;
        }
...
/* TFLAGG2 */() {
    ...
    Base["prototype"].updateLocationDataIfMissing = function
...
/* TFLAGG2 */(message) {
    ...
    Base["prototype"].makeCode = function
/* TFLAGG2 */(code) {
      return new CodeFragment(this, code);
    };

    Base["prototype"].wrapInBraces = function
/* TFLAGG2 */(fragments) {
      return [].concat(this.makeCode('('), fragments, this.makeCode(')'));
    };

    Base["prototype"].joinFragmentArrays = function
...
/* TFLAGG2 */() {
    ...
    Block["prototype"].unshift = function
/* TFLAGG2 */(node) {
...
/* TFLAGG2 */(res) {
    ...
    Block["prototype"].compileToFragments = function
/* TFLAGG2 */(o, level) {
      if (o == null) {
        o = {};
      }
    ...
    Block["prototype"].compileNode = function
/* TFLAGG2 */(o) {
    ...
    Block["prototype"].compileRoot = function
/* TFLAGG2 */(o) {
...
/* TFLAGG2 */() {
    ...
    Block["prototype"].compileWithDeclarations = function
/* TFLAGG2 */(o) {
...
/* TFLAGG2 */() {
    ...
    Literal["prototype"].assigns = function
/* TFLAGG2 */(name) {
      return name === this.value;
    };

    Literal["prototype"].jumps = function
/* TFLAGG2 */(o) {
...
/* TFLAGG2 */ Undefined() {
    ...
    Undefined["prototype"].compileNode = function
/* TFLAGG2 */(o) {
...
/* TFLAGG2 */ Return(expr) {
    ...
    Return["prototype"].compileToFragments = function
/* TFLAGG2 */(o, level) {
      var expr, _ref4;
    ...
    Return["prototype"].compileNode = function
/* TFLAGG2 */(o) {
      var answer;
...
/* TFLAGG2 */() {
    ...
    Value["prototype"].isStatement = function
/* TFLAGG2 */(o) {
      return !this.properties.length && this.base.isStatement(o);
    };

    Value["prototype"].assigns = function
/* TFLAGG2 */(name) {
...
/* TFLAGG2 */() {
    ...
    Value["prototype"].cacheReference = function
/* TFLAGG2 */(o) {
    ...
    Value["prototype"].compileNode = function
/* TFLAGG2 */(o) {
    ...
    Value["prototype"].unfoldSoak = function
/* TFLAGG2 */(o) {
      var _ref4,
        _this = this;
...
/* TFLAGG2 */() {
    ...
    Call["prototype"].superReference = function
/* TFLAGG2 */(o) {
      var accesses, method;
    ...
    Call["prototype"].superThis = function
/* TFLAGG2 */(o) {
      var method;
    ...
    Call["prototype"].unfoldSoak = function
/* TFLAGG2 */(o) {
    ...
    Call["prototype"].compileNode = function
/* TFLAGG2 */(o) {
    ...
    Call["prototype"].compileSplat = function
/* TFLAGG2 */(o, splatArgs) {
...
/* TFLAGG2 */ Extends(child, parent) {
    ...
    Extends["prototype"].compileToFragments = function
/* TFLAGG2 */(o) {
...
/* TFLAGG2 */ Access(name, tag) {
    ...
    Access["prototype"].compileToFragments = function
/* TFLAGG2 */(o) {
      var name;
...
/* TFLAGG2 */ Index(index) {
    ...
    Index["prototype"].compileToFragments = function
/* TFLAGG2 */(o) {
...
/* TFLAGG2 */ Range(from, to, tag) {
    ...
    Range["prototype"].compileVariables = function
/* TFLAGG2 */(o) {
    ...
    Range["prototype"].compileNode = function
/* TFLAGG2 */(o) {
    ...
    Range["prototype"].compileArray = function
/* TFLAGG2 */(o) {
      ...
      hasArgs = function
/* TFLAGG2 */(node) {
        return node != null ? node.contains(function
/* TFLAGG2 */(n) {
...
/* TFLAGG2 */ Slice(range) {
    ...
    Slice["prototype"].compileNode = function
/* TFLAGG2 */(o) {
...
/* TFLAGG2 */ Obj(props, generated) {
    ...
    Obj["prototype"].compileNode = function
/* TFLAGG2 */(o) {
    ...
    Obj["prototype"].assigns = function
/* TFLAGG2 */(name) {
...
/* TFLAGG2 */ Arr(objs) {
    ...
    Arr["prototype"].compileNode = function
/* TFLAGG2 */(o) {
...
/* TFLAGG2 */() {
    ...
    Arr["prototype"].assigns = function
/* TFLAGG2 */(name) {
...
/* TFLAGG2 */() {
    ...
    Class["prototype"].setContext = function
/* TFLAGG2 */(name) {
      return this.body.traverseChildren(false, function
/* TFLAGG2 */(node) {
        if (node.classBody) {
          return false;
        }
    ...
    Class["prototype"].addBoundFunctions = function
/* TFLAGG2 */(o) {
...
/* TFLAGG2 */() {
    ...
    Class["prototype"].walkBody = function
/* TFLAGG2 */(name, o) {
      var _this = this;

      return this.traverseChildren(false, function
/* TFLAGG2 */(child) {
...
/* TFLAGG2 */() {
    ...
    Class["prototype"].ensureConstructor = function
/* TFLAGG2 */(name, o) {
    ...
    Class["prototype"].compileNode = function
/* TFLAGG2 */(o) {
...
/* TFLAGG2 */(o) {
    ...
    Assign["prototype"].compileNode = function
/* TFLAGG2 */(o) {
    ...
    Assign["prototype"].compilePatternMatch = function
/* TFLAGG2 */(o) {
    ...
    Assign["prototype"].compileConditional = function
/* TFLAGG2 */(o) {
    ...
    Assign["prototype"].compileSplice = function
/* TFLAGG2 */(o) {
...
/* TFLAGG2 */() {
    ...
    Code["prototype"].compileNode = function
/* TFLAGG2 */(o) {
...
/* TFLAGG2 */(name, node) {
    ...
    Code["prototype"].eachParamName = function
/* TFLAGG2 */(iterator) {
    ...
    Code["prototype"].traverseChildren = function
/* TFLAGG2 */(crossScope, func) {
      if (crossScope) {
...
/* TFLAGG2 */ Param(name, value, splat) {
    ...
    Param["prototype"].compileToFragments = function
/* TFLAGG2 */(o) {
      return this.name.compileToFragments(o, LEVEL_LIST);
    };

    Param["prototype"].asReference = function
/* TFLAGG2 */(o) {
      var node;
...
/* TFLAGG2 */() {
    ...
    Param["prototype"].eachName = function
...
/* TFLAGG2 */(name) {
    ...
    Splat["prototype"].compileToFragments = function
/* TFLAGG2 */(o) {
...
/* TFLAGG2 */() {
    ...
    Splat.compileSplattedArray = function
...
/* TFLAGG2 */(res) {
    ...
    While["prototype"].addBody = function
/* TFLAGG2 */(body) {
      this.body = body;
      return this;
    };
...
/* TFLAGG2 */() {
    ...
    While["prototype"].compileNode = function
/* TFLAGG2 */(o) {
...
/* TFLAGG2 */(o) {
    ...
    Op["prototype"].generateDo = function
/* TFLAGG2 */(exp) {
    ...
    Op["prototype"].compileNode = function
/* TFLAGG2 */(o) {
    ...
    Op["prototype"].compileChain = function
/* TFLAGG2 */(o) {
    ...
    Op["prototype"].compileExistence = function
/* TFLAGG2 */(o) {
      var fst, ref;
    ...
    Op["prototype"].compileUnary = function
/* TFLAGG2 */(o) {
...
/* TFLAGG2 */ In(object, array) {
    ...
    In["prototype"].compileNode = function
/* TFLAGG2 */(o) {
    ...
    In["prototype"].compileOrTest = function
/* TFLAGG2 */(o) {
    ...
    In["prototype"].compileLoopTest = function
/* TFLAGG2 */(o) {
...
/* TFLAGG2 */(res) {
    ...
    Try["prototype"].compileNode = function
/* TFLAGG2 */(o) {
...
/* TFLAGG2 */ Throw(expression) {
    ...
    Throw["prototype"].compileNode = function
/* TFLAGG2 */(o) {
...
/* TFLAGG2 */ Existence(expression) {
    ...
    Existence["prototype"].compileNode = function
/* TFLAGG2 */(o) {
...
/* TFLAGG2 */() {
    ...
    Parens["prototype"].compileNode = function
/* TFLAGG2 */(o) {
...
/* TFLAGG2 */ For(body, source) {
    ...
    For["prototype"].compileNode = function
/* TFLAGG2 */(o) {
    ...
    For["prototype"].pluckDirectCall = function
/* TFLAGG2 */(o, body) {
...
/* TFLAGG2 */ Switch(subject, cases, otherwise) {
    ...
    Switch["prototype"].jumps = function
/* TFLAGG2 */(o) {
...
/* TFLAGG2 */(res) {
    ...
    Switch["prototype"].compileNode = function
/* TFLAGG2 */(o) {
...
/* TFLAGG2 */(o) {
    ...
    If["prototype"].compileNode = function
/* TFLAGG2 */(o) {
...
/* TFLAGG2 */(res) {
    ...
    If["prototype"].ensureBlock = function
/* TFLAGG2 */(node) {
      if (node instanceof Block) {
        return node;
      } else {
    ...
    If["prototype"].compileStatement = function
/* TFLAGG2 */(o) {
    ...
    If["prototype"].compileExpression = function
/* TFLAGG2 */(o) {
...
/* TFLAGG2 */(expressions, statement, noReturn) {
    ...
    isLiteralArguments: function
/* TFLAGG2 */(node) {
      return node instanceof Literal && node.value === 'arguments' && !node.asKey;
    },
    isLiteralThis: function
/* TFLAGG2 */(node) {

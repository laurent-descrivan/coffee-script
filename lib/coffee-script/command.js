...
/* TFLAGG2 */(source, topLevel, base) {
    return fs.stat(source, function
/* TFLAGG2 */(err, stats) {
      ...
      if (stats.isDirectory() && path.dirname(source) !== 'node_modules') {
        ...
        return fs.readdir(source, function
/* TFLAGG2 */(err, files) {
...
/* TFLAGG2 */(file) {
        ...
        return fs.readFile(source, function
/* TFLAGG2 */(err, code) {
          if (err && err.code !== 'ENOENT') {
            throw err;
          }
...
/* TFLAGG2 */(source, base, removeJs) {
    ...
    if (removeJs && !opts.join) {
      ...
      return exists(jsPath, function
/* TFLAGG2 */(itExists) {
        if (itExists) {
          return fs.unlink(jsPath, function
/* TFLAGG2 */(err) {
            if (err && err.code !== 'ENOENT') {
              throw err;
            }
...
/* TFLAGG2 */() {
      if (opts.compile) {
        ...
        fs.writeFile(jsPath, js, function
/* TFLAGG2 */(err) {
          if (err) {
      ...
      if (generatedSourceMap) {
        return fs.writeFile(sourceMapPath, generatedSourceMap, function
/* TFLAGG2 */(err) {
          if (err) {

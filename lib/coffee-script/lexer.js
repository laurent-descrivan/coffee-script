...
/* TFLAGG2 */(code, opts) {
    ...
    Lexer["prototype"].clean = function
/* TFLAGG2 */(code) {
...
/* TFLAGG2 */() {
    ...
    Lexer["prototype"].sanitizeHeredoc = function
/* TFLAGG2 */(doc, options) {
...
/* TFLAGG2 */(str, end) {
    ...
    Lexer["prototype"].interpolateString = function
/* TFLAGG2 */(str, options) {
...
/* TFLAGG2 */(tag) {
    ...
    Lexer["prototype"].getLineAndColumnFromChunk = function
/* TFLAGG2 */(offset) {
...
/* TFLAGG2 */() {
    ...
    Lexer["prototype"].escapeLines = function
/* TFLAGG2 */(str, heredoc) {
      return str.replace(MULTILINER, heredoc ? '\\n' : '');
    };

    Lexer["prototype"].makeString = function

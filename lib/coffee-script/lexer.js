...
(function() {
  ...
  exports.Lexer = Lexer = ((__ayl_stackify(function
/* TFLAGG2 */() {
    function
/* TFLAGG2 */ Lexer() {}

    Lexer["prototype"].tokenize = (__ayl_stackify(function
/* TFLAGG2 */(code, opts) {
    ...
    Lexer["prototype"].clean = (__ayl_stackify(function
/* TFLAGG2 */(code) {
    ...
    Lexer["prototype"].identifierToken = (__ayl_stackify(function
/* TFLAGG2 */() {
...
/* TFLAGG2 */() {
    ...
    Lexer["prototype"].numberToken = (__ayl_stackify(function
/* TFLAGG2 */() {
    ...
    Lexer["prototype"].stringToken = (__ayl_stackify(function
/* TFLAGG2 */() {
    ...
    Lexer["prototype"].heredocToken = (__ayl_stackify(function
/* TFLAGG2 */() {
    ...
    Lexer["prototype"].commentToken = (__ayl_stackify(function
/* TFLAGG2 */() {
    ...
    Lexer["prototype"].jsToken = (__ayl_stackify(function
/* TFLAGG2 */() {
      var match, script;
    ...
    Lexer["prototype"].regexToken = (__ayl_stackify(function
/* TFLAGG2 */() {
    ...
    Lexer["prototype"].heregexToken = (__ayl_stackify(function
/* TFLAGG2 */(match) {
    ...
    Lexer["prototype"].lineToken = (__ayl_stackify(function
/* TFLAGG2 */() {
    ...
    Lexer["prototype"].outdentToken = (__ayl_stackify(function
/* TFLAGG2 */(moveOut, noNewlines, outdentLength) {
      var dent, len;
    ...
    Lexer["prototype"].whitespaceToken = (__ayl_stackify(function
/* TFLAGG2 */() {
    ...
    Lexer["prototype"].newlineToken = (__ayl_stackify(function
/* TFLAGG2 */(offset) {
      while (this.value() === ';') {
        this.tokens.pop();
      }
    ...
    Lexer["prototype"].suppressNewlines = (__ayl_stackify(function
/* TFLAGG2 */() {
      if (this.value() === '\\') {
        this.tokens.pop();
      }
    ...
    Lexer["prototype"].literalToken = (__ayl_stackify(function
/* TFLAGG2 */() {
    ...
    Lexer["prototype"].sanitizeHeredoc = (__ayl_stackify(function
/* TFLAGG2 */(doc, options) {
    ...
    Lexer["prototype"].tagParameters = (__ayl_stackify(function
/* TFLAGG2 */() {
    ...
    Lexer["prototype"].closeIndentation = (__ayl_stackify(function
/* TFLAGG2 */() {
      return this.outdentToken(this.indent);
    }));

    Lexer["prototype"].balancedString = (__ayl_stackify(function
/* TFLAGG2 */(str, end) {
    ...
    Lexer["prototype"].interpolateString = (__ayl_stackify(function
/* TFLAGG2 */(str, options) {
    ...
    Lexer["prototype"].pair = (__ayl_stackify(function
/* TFLAGG2 */(tag) {
      var size, wanted;
    ...
    Lexer["prototype"].getLineAndColumnFromChunk = (__ayl_stackify(function
/* TFLAGG2 */(offset) {
    ...
    Lexer["prototype"].makeToken = (__ayl_stackify(function
/* TFLAGG2 */(tag, value, offsetInChunk, length) {
    ...
    Lexer["prototype"].token = (__ayl_stackify(function
/* TFLAGG2 */(tag, value, offsetInChunk, length) {
      var token;
    ...
    Lexer["prototype"].tag = (__ayl_stackify(function
/* TFLAGG2 */(index, tag) {
      var tok;
    ...
    Lexer["prototype"].value = (__ayl_stackify(function
/* TFLAGG2 */(index, val) {
      var tok;
    ...
    Lexer["prototype"].unfinished = (__ayl_stackify(function
/* TFLAGG2 */() {
      var _ref2;
    ...
    Lexer["prototype"].escapeLines = (__ayl_stackify(function
/* TFLAGG2 */(str, heredoc) {
      return str.replace(MULTILINER, heredoc ? '\\n' : '');
    }));

    Lexer["prototype"].makeString = (__ayl_stackify(function
/* TFLAGG2 */(body, quote, heredoc) {
      if (!body) {
        return quote + quote;
      }
      body = body.replace(/\\([\s\S])/g, (__ayl_stackify(function
/* TFLAGG2 */(match, contents) {
        if (contents === '\n' || contents === quote) {
          return contents;
        } else {
          return match;
    ...
    Lexer["prototype"].error = (__ayl_stackify(function
/* TFLAGG2 */(message) {
  ...
  COFFEE_ALIASES = ((__ayl_stackify(function
/* TFLAGG2 */() {
    var _results;

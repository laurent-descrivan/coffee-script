...
(function() {
  ...
  generate = (__ayl_stackify(function
/* TFLAGG2 */(tag, value) {
    var tok;
  ...
  exports.Rewriter = ((__ayl_stackify(function
/* TFLAGG2 */() {
    function
/* TFLAGG2 */ Rewriter() {}

    Rewriter["prototype"].rewrite = (__ayl_stackify(function
/* TFLAGG2 */(tokens) {
      this.tokens = tokens;
    ...
    Rewriter["prototype"].scanTokens = (__ayl_stackify(function
/* TFLAGG2 */(block) {
      var i, token, tokens;
    ...
    Rewriter["prototype"].detectEnd = (__ayl_stackify(function
/* TFLAGG2 */(i, condition, action) {
    ...
    Rewriter["prototype"].removeLeadingNewlines = (__ayl_stackify(function
/* TFLAGG2 */() {
    ...
    Rewriter["prototype"].removeMidExpressionNewlines = (__ayl_stackify(function
/* TFLAGG2 */() {
      return this.scanTokens((__ayl_stackify(function
/* TFLAGG2 */(token, i, tokens) {
        var _ref;
    ...
    Rewriter["prototype"].closeOpenCalls = (__ayl_stackify(function
/* TFLAGG2 */() {
      var action, condition;

      condition = (__ayl_stackify(function
/* TFLAGG2 */(token, i) {
        var _ref;

        return ((_ref = token[0]) === ')' || _ref === 'CALL_END') || token[0] === 'OUTDENT' && this.tag(i - 1) === ')';
      }));
      action = (__ayl_stackify(function
/* TFLAGG2 */(token, i) {
...
/* TFLAGG2 */(token, i) {
    ...
    Rewriter["prototype"].closeOpenIndexes = (__ayl_stackify(function
/* TFLAGG2 */() {
      var action, condition;
...
/* TFLAGG2 */(token, i) {
    ...
    Rewriter["prototype"].matchTags = (__ayl_stackify(function
/* TFLAGG2 */() {
    ...
    Rewriter["prototype"].looksObjectish = (__ayl_stackify(function
/* TFLAGG2 */(j) {
      return this.matchTags(j, '@', null, ':') || this.matchTags(j, null, ':');
    }));

    Rewriter["prototype"].findTagsBackwards = (__ayl_stackify(function
/* TFLAGG2 */(i, tags) {
    ...
    Rewriter["prototype"].addImplicitBracesAndParens = (__ayl_stackify(function
/* TFLAGG2 */() {
      var stack;
...
/* TFLAGG2 */(token, i, tokens) {
        ...
        stackTop = (__ayl_stackify(function
/* TFLAGG2 */() {
          return stack[stack.length - 1];
        }));
        startIdx = i;
        forward = (__ayl_stackify(function
/* TFLAGG2 */(n) {
          return i - startIdx + n;
        }));
        inImplicit = (__ayl_stackify(function
/* TFLAGG2 */() {
          var _ref, _ref1;

          return (_ref = stackTop()) != null ? (_ref1 = _ref[2]) != null ? _ref1.ours : void 0 : void 0;
        }));
        inImplicitCall = (__ayl_stackify(function
/* TFLAGG2 */() {
          var _ref;

          return inImplicit() && ((_ref = stackTop()) != null ? _ref[0] : void 0) === '(';
        }));
        inImplicitObject = (__ayl_stackify(function
/* TFLAGG2 */() {
          var _ref;

          return inImplicit() && ((_ref = stackTop()) != null ? _ref[0] : void 0) === '{';
        }));
        inImplicitControl = (__ayl_stackify(function
/* TFLAGG2 */() {
          var _ref;

          return inImplicit && ((_ref = stackTop()) != null ? _ref[0] : void 0) === 'CONTROL';
        }));
        startImplicitCall = (__ayl_stackify(function
/* TFLAGG2 */(j) {
          var idx;
        ...
        endImplicitCall = (__ayl_stackify(function
/* TFLAGG2 */() {
          stack.pop();
          tokens.splice(i, 0, generate('CALL_END', ')'));
          return i += 1;
        }));
        startImplicitObject = (__ayl_stackify(function
/* TFLAGG2 */(j, startsLine) {
          var idx;
        ...
        endImplicitObject = (__ayl_stackify(function
/* TFLAGG2 */(j) {
          j = j != null ? j : i;
          stack.pop();
    ...
    Rewriter["prototype"].addLocationDataToGeneratedTokens = (__ayl_stackify(function
/* TFLAGG2 */() {
      return this.scanTokens((__ayl_stackify(function
/* TFLAGG2 */(token, i, tokens) {
    ...
    Rewriter["prototype"].addImplicitIndentation = (__ayl_stackify(function
/* TFLAGG2 */() {
...
/* TFLAGG2 */(token, i, tokens) {
    ...
    Rewriter["prototype"].tagPostfixConditionals = (__ayl_stackify(function
/* TFLAGG2 */() {
...
/* TFLAGG2 */(token, i) {
    ...
    Rewriter["prototype"].indentation = (__ayl_stackify(function
/* TFLAGG2 */(implicit) {
      var indent, outdent;
    ...
    Rewriter["prototype"].tag = (__ayl_stackify(function
/* TFLAGG2 */(i) {
      var _ref;

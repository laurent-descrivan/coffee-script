...
/* TFLAGG2 */(tokens) {
    ...
    Rewriter["prototype"].scanTokens = function
/* TFLAGG2 */(block) {
      var i, token, tokens;
...
/* TFLAGG2 */() {
      return this.scanTokens(function
...
/* TFLAGG2 */() {
    ...
    Rewriter["prototype"].looksObjectish = function
/* TFLAGG2 */(j) {
      return this.matchTags(j, '@', null, ':') || this.matchTags(j, null, ':');
    };

    Rewriter["prototype"].findTagsBackwards = function
/* TFLAGG2 */(i, tags) {
...
/* TFLAGG2 */(token, i) {
    ...
    Rewriter["prototype"].indentation = function
/* TFLAGG2 */(implicit) {
      var indent, outdent;
    ...
    Rewriter["prototype"].tag = function
/* TFLAGG2 */(i) {
      var _ref;

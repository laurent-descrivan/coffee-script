...
(function() {
  ...
  exports.OptionParser = OptionParser = ((__ayl_stackify(function
/* TFLAGG2 */() {
    function
/* TFLAGG2 */ OptionParser(rules, banner) {
      this.banner = banner;
      this.rules = buildRules(rules);
    }

    OptionParser["prototype"].parse = (__ayl_stackify(function
/* TFLAGG2 */(args) {
    ...
    OptionParser["prototype"].help = (__ayl_stackify(function
/* TFLAGG2 */() {
  ...
  buildRules = (__ayl_stackify(function
/* TFLAGG2 */(rules) {
  ...
  buildRule = (__ayl_stackify(function
/* TFLAGG2 */(shortFlag, longFlag, description, options) {
    var match;
  ...
  normalizeArguments = (__ayl_stackify(function
/* TFLAGG2 */(args) {

...
(function() {
  ...
  replDefaults = {
    prompt: 'coffee> ',
    "eval": (__ayl_stackify(function
/* TFLAGG2 */(input, context, filename, cb) {
  ...
  addMultilineHandler = (__ayl_stackify(function
/* TFLAGG2 */(repl) {
    ...
    multiline = {
      enabled: false,
      initialPrompt: repl.prompt.replace(/^[^> ]*/, (__ayl_stackify(function
/* TFLAGG2 */(x) {
        return x.replace(/./g, '-');
      }))),
      prompt: repl.prompt.replace(/^[^> ]*>?/, (__ayl_stackify(function
/* TFLAGG2 */(x) {
        return x.replace(/./g, '.');
      }))),
      buffer: ''
    ...
    rli.on('line', (__ayl_stackify(function
/* TFLAGG2 */(cmd) {
    ...
    return inputStream.on('keypress', (__ayl_stackify(function
/* TFLAGG2 */(char, key) {
...
/* TFLAGG2 */(opts) {
      ...
      _ref1 = process.versions.node.split('.').map((__ayl_stackify(function
/* TFLAGG2 */(n) {
        return parseInt(n);
      ...
      repl.on('exit', (__ayl_stackify(function
/* TFLAGG2 */() {

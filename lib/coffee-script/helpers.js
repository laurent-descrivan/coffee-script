...
(function() {
  ...
  exports.starts = (__ayl_stackify(function
/* TFLAGG2 */(string, literal, start) {
    return literal === string.substr(start, literal.length);
  }));

  exports.ends = (__ayl_stackify(function
/* TFLAGG2 */(string, literal, back) {
  ...
  exports.repeat = repeat = (__ayl_stackify(function
/* TFLAGG2 */(str, n) {
    var res;
  ...
  exports.compact = (__ayl_stackify(function
/* TFLAGG2 */(array) {
  ...
  exports.count = (__ayl_stackify(function
/* TFLAGG2 */(string, substr) {
  ...
  exports.merge = (__ayl_stackify(function
/* TFLAGG2 */(options, overrides) {
    return extend(extend({}, options), overrides);
  }));

  extend = exports.extend = (__ayl_stackify(function
/* TFLAGG2 */(object, properties) {
  ...
  exports.flatten = flatten = (__ayl_stackify(function
/* TFLAGG2 */(array) {
  ...
  exports.del = (__ayl_stackify(function
/* TFLAGG2 */(obj, key) {
    var val;
  ...
  exports.last = last = (__ayl_stackify(function
/* TFLAGG2 */(array, back) {
    return array[array.length - (back || 0) - 1];
  }));

  exports.some = (_ref = Array.prototype.some) != null ? _ref : (__ayl_stackify(function
/* TFLAGG2 */(fn) {
    var e, _i, _len;
  ...
  exports.invertLiterate = (__ayl_stackify(function
/* TFLAGG2 */(code) {
    var line, lines, maybe_code;

    maybe_code = true;
    lines = ((__ayl_stackify(function
/* TFLAGG2 */() {
  ...
  buildLocationData = (__ayl_stackify(function
/* TFLAGG2 */(first, last) {
    if (!last) {
      return first;
    } else {
  ...
  exports.addLocationDataFn = (__ayl_stackify(function
/* TFLAGG2 */(first, last) {
...
/* TFLAGG2 */(obj) {
  ...
  exports.locationDataToString = (__ayl_stackify(function
/* TFLAGG2 */(obj) {
    var locationData;
  ...
  exports.baseFileName = (__ayl_stackify(function
/* TFLAGG2 */(file, stripExt, pathSep) {
  ...
  exports.isCoffee = (__ayl_stackify(function
/* TFLAGG2 */(file) {
    return /\.((lit)?coffee|coffee\.md)$/.test(file);
  }));

  exports.isLiterate = (__ayl_stackify(function
/* TFLAGG2 */(file) {
    return /\.(litcoffee|coffee\.md)$/.test(file);
  }));

  exports.throwSyntaxError = (__ayl_stackify(function
/* TFLAGG2 */(message, location) {
  ...
  exports.prettyErrorMessage = (__ayl_stackify(function
/* TFLAGG2 */(error, fileName, code, useColors) {
    ...
    if (useColors) {
      colorize = (__ayl_stackify(function
/* TFLAGG2 */(str) {

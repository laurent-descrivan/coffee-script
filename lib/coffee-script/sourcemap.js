...
/* TFLAGG2 */ LineMapping(generatedLine) {
    ...
    LineMapping["prototype"].addMapping = function
/* TFLAGG2 */(generatedColumn, _arg, options) {
      ...
      return this.columnMappings.sort(function
/* TFLAGG2 */(a, b) {
        return a.generatedColumn - b.generatedColumn;
      });
    };

    LineMapping["prototype"].getSourcePosition = function
...
/* TFLAGG2 */ SourceMap() {
    ...
    SourceMap["prototype"].addMapping = function
/* TFLAGG2 */(sourceLocation, generatedLocation, options) {
    ...
    SourceMap["prototype"].getSourcePosition = function
/* TFLAGG2 */(_arg) {
    ...
    SourceMap["prototype"].forEachMapping = function
/* TFLAGG2 */(fn) {
...
/* TFLAGG2 */() {
  ...
  exports.generateV3SourceMap = function
/* TFLAGG2 */(sourceMap, options, code) {
    ...
    needComma = false;
    mappings = "";
    sourceMap.forEachMapping(function
/* TFLAGG2 */(mapping) {
  ...
  exports.loadV3SourceMap = function
/* TFLAGG2 */(sourceMap) {
    return todo();
  };
...
/* TFLAGG2 */(char) {
  ...
  exports.vlqEncodeValue = function
/* TFLAGG2 */(value) {
  ...
  exports.vlqDecodeValue = function
/* TFLAGG2 */(str, offset) {

...
(function() {
  ...
  LineMapping = ((__ayl_stackify(function
/* TFLAGG2 */() {
    function
/* TFLAGG2 */ LineMapping(generatedLine) {
      this.generatedLine = generatedLine;
      this.columnMap = {};
      this.columnMappings = [];
    }

    LineMapping["prototype"].addMapping = (__ayl_stackify(function
/* TFLAGG2 */(generatedColumn, _arg, options) {
      ...
      return this.columnMappings.sort((__ayl_stackify(function
/* TFLAGG2 */(a, b) {
        return a.generatedColumn - b.generatedColumn;
      })));
    }));

    LineMapping["prototype"].getSourcePosition = (__ayl_stackify(function
/* TFLAGG2 */(generatedColumn) {
  ...
  exports.SourceMap = ((__ayl_stackify(function
/* TFLAGG2 */() {
    function
/* TFLAGG2 */ SourceMap() {
      this.generatedLines = [];
    ...
    SourceMap["prototype"].addMapping = (__ayl_stackify(function
/* TFLAGG2 */(sourceLocation, generatedLocation, options) {
    ...
    SourceMap["prototype"].getSourcePosition = (__ayl_stackify(function
/* TFLAGG2 */(_arg) {
    ...
    SourceMap["prototype"].forEachMapping = (__ayl_stackify(function
/* TFLAGG2 */(fn) {
      ...
      for (generatedLineNumber = _i = 0, _len = _ref['length']; _i < _len; generatedLineNumber = ++_i) {
        ...
        if (lineMapping) {
          _results['push'](((__ayl_stackify(function
/* TFLAGG2 */() {
  ...
  exports.generateV3SourceMap = (__ayl_stackify(function
/* TFLAGG2 */(sourceMap, options, code) {
    ...
    needComma = false;
    mappings = "";
    sourceMap.forEachMapping((__ayl_stackify(function
/* TFLAGG2 */(mapping) {
  ...
  exports.loadV3SourceMap = (__ayl_stackify(function
/* TFLAGG2 */(sourceMap) {
    return todo();
  }));
  ...
  encodeBase64Char = (__ayl_stackify(function
/* TFLAGG2 */(value) {
  ...
  decodeBase64Char = (__ayl_stackify(function
/* TFLAGG2 */(char) {
    var value;
  ...
  exports.vlqEncodeValue = (__ayl_stackify(function
/* TFLAGG2 */(value) {
  ...
  exports.vlqDecodeValue = (__ayl_stackify(function
/* TFLAGG2 */(str, offset) {

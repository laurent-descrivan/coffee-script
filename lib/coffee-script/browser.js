...
(function() {
  ...
  CoffeeScript["eval"] = (__ayl_stackify(function
/* TFLAGG2 */(code, options) {
  ...
  CoffeeScript.run = (__ayl_stackify(function
/* TFLAGG2 */(code, options) {
    if (options == null) {
      options = {};
    }
...
/* TFLAGG2 */(code, options) {
  ...
  CoffeeScript.load = (__ayl_stackify(function
/* TFLAGG2 */(url, callback, options) {
    var xhr;
    ...
    xhr.onreadystatechange = (__ayl_stackify(function
/* TFLAGG2 */() {
      var _ref;
...
/* TFLAGG2 */() {
    ...
    (execute = (__ayl_stackify(function
/* TFLAGG2 */() {
